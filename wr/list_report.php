...
$query = "SELECT r.id, r.content, t.team_name, r.report_date, r.team_id FROM reports r JOIN teams t ON r.team_id = t.id $conditions ORDER BY r.report_date DESC LIMIT :perPage OFFSET :offset";
